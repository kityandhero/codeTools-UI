export default {
  ...
  'menu.product': '商品中心',
  // 'menu.product.supervise': '商品信息',
  // 'menu.product.supervise.list': '商品列表',
  // 'menu.product.supervise.add': '发布新品',
  // 'menu.product.supervise.edit': '编辑商品',
  // 'menu.product.supervise.edit.basicInfo': '基本信息',
  // 'menu.product.supervise.edit.contentInfo': '详细描述',
  ...
  'menu.product.config': '设置',
  'menu.product.config.productType': '自定分类',
  'menu.product.config.customBrand': '自定品牌',
  'menu.product.config.productUnit': '自定规格',
  'menu.order': '订单处理',
  ...
  'menu.orderProcessing.transit': '出库中',
  'menu.orderProcessing.dispatching': '配送中',
  'menu.orderProcessing.completedCompleted': '已完成',
