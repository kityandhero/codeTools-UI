...
import { Card, Button, Radio, Form, Input, Spin, Table, BackTop, Divider, Icon } from 'antd';
...
class ReplenishmentInfo extends TabPageBase {
  ...
  supplementSubmitRequestParams = o => {
    const d = o;
    const { replenishmentId, replenishmentStateMode } = this.state;
    ...
    return (
      <Fragment>
        <div className={styles.containorBox}>
          ...
          <Card className={styles.card} bordered={false}>
            <Spin spinning={dataLoading || processing}>
              <div className={styles.title}>售后商品</div>
              <Table
