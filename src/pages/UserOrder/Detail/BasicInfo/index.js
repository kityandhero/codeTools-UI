            ...
            extra={
              <Affix offsetTop={20}>
                ...
                <Popconfirm
                  placement="bottom"
                  title="打印小票，确定吗？"
                  // onConfirm={e => this.setSingleLineDispatchFinish(e)}
                  okText="确定"
                  cancelText="取消"
                >
                  <Button
          ...
          <Card title="配送信息" className={styles.card} bordered={false}>
            <Spin spinning={dataLoading || processing}>
              <DescriptionList
                ...
                col="2"
              >
                <Description term="配送人员">
                  {metaData === null ? '' : metaData.expressName || ''}
                </Description>
                <Description term="配送说明">
                  {metaData === null ? '' : metaData.explain || ''}
                </Description>
                <Description term="收件地址">
                  {metaData === null
                    ? ''
                    : `${metaData.sendConsignee} | ${metaData.sendPhone} | ${
                        metaData.sendAddress
                      } | ${metaData.sendStreetAddress}` || ''}
                </Description>
              </DescriptionList>
            </Spin>
          </Card>
