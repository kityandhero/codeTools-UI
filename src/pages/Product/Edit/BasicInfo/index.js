...
class BasicInfo extends TabPageBase {
  ...
  showChangeImageSortModal = () => {
    const { changeImageSortModalVisible } = this.state;
    if (!changeImageSortModalVisible) {
  ...
  afterChangeImageSortModalOk = data => {
    this.setState({
      changeImageSortModalVisible: false,
    });
            ...
            {saleTimeSwitch ? (
              <Spin spinning={dataLoading || processing}>
                <Form layout="vertical">
                  <Row gutter={24}>
                    <Col lg={6} md={12} sm={24}>
                      {this.renderFormProductSaleTimeModeFormItem(saleTimeModeSelected, e => {
                        this.setState({ saleTimeSwitch: e !== 0, saleTimeModeSelected: e });
                      })}
                    </Col>
                    <Col lg={6} md={12} sm={24}>
                      <FormItem label={fieldData.beginSaleTime}>
                        {getFieldDecorator(
                          'beginSaleTime',
                          refitFieldDecoratorOption(
                            saleTimeModeSelected === 0 || saleTimeModeSelected === 2
                              ? null
                              : metaData === null
                              ? null
                              : stringToMoment(metaData.beginSaleTime || '') || null,
                            true,
                            null,
                            {
                              rules: [
                                {
                                  ...
                                  message: buildFieldDescription(fieldData.beginSaleTime),
                                },
                              ],
                            },
                            v => stringToMoment(v),
                          ...
                          <DatePicker
                            ...
                            inputReadOnly
                            disabled={saleTimeModeSelected === 0 || saleTimeModeSelected === 2}
                            placeholder={buildFieldDescription(fieldData.beginSaleTime, '选择')}
                          />,
                        )}
                      </FormItem>
                    </Col>
                    <Col lg={6} md={12} sm={24}>
                      <FormItem label={fieldData.endSaleTime}>
                        {getFieldDecorator(
                          'endSaleTime',
                          refitFieldDecoratorOption(
                            saleTimeModeSelected === 0 || saleTimeModeSelected === 1
                              ? null
                              : metaData === null
                              ? null
                              : stringToMoment(metaData.endSaleTime || '') || null,
                            true,
                            null,
                            {
                              rules: [
                                {
                                  ...
                                  message: buildFieldDescription(fieldData.endSaleTime),
                                },
                              ],
                            },
                            v => stringToMoment(v),
                          ...
                          <DatePicker
                            ...
                            format="YYYY-MM-DD HH:mm:ss"
                            inputReadOnly
                            disabled={saleTimeModeSelected === 0 || saleTimeModeSelected === 1}
                            placeholder={buildFieldDescription(fieldData.endSaleTime, '选择')}
                          />,
                        )}
                      </FormItem>
                    </Col>
            ...
            extra={
              <>
                <Button
                  ...
                  disabled={dataLoading || processing || !loadSuccess}
                  title="调整图片顺序"
                  onClick={e => this.showChangeImageSortModal(e)}
                >
                  调整图片顺序
                </Button>
              </>
