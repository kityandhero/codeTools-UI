    ...
    routes: [
      ...
      },
      {
        ...
        authority: [
          ...
          accessWayCollection.discountActivities.add,
          accessWayCollection.discountActivities.list,
        ],
        routes: [
          { path: '/marketing', redirect: '/marketing/discount' },
          {
            name: 'discount',
            icon: 'shop',
            ...
            authority: [
              accessWayCollection.super,
              accessWayCollection.discountActivities.addBasicInfo,
              accessWayCollection.discountActivities.list,
            ],
            routes: [
              { path: '/marketing/discount', redirect: '/marketing/discount/list/no' },
              {
                ...
                component: './DiscountActivities/Add',
              },
              {
                path: '/marketing/discount/list/:pageKey',
                hideInMenu: true,
                component: './DiscountActivities/List',
              },
              { path: '/marketing/discount/list/', redirect: '/marketing/discount/list/no' },
              {
                path: '/marketing/discount/list/no',
                name: 'list',
                icon: 'bars',
                authority: [accessWayCollection.super, accessWayCollection.discountActivities.list],
              },
              {
                path: '/marketing/discount/edit/:op/:id/:pageKey',
                name: 'edit',
                hideInMenu: true,
                component: './DiscountActivities/Edit',
                routes: [
                  {
                    path: '/marketing/discount/edit/:op/:id/:pageKey/basicInfo',
                    name: 'basicInfo',
                    component: './DiscountActivities/Edit/BasicInfo',
                  },
                ],
              },
            ],
          },
          {
            name: 'planSale',
            icon: 'shop',
            path: '/marketing/planSale',
            authority: [
              accessWayCollection.super,
              accessWayCollection.planSale.addBasicInfo,
              accessWayCollection.planSale.list,
            ],
            routes: [
              { path: '/marketing/planSale', redirect: '/marketing/planSale/list/no' },
              {
                path: '/marketing/planSale/add',
                name: 'add',
                icon: 'plus-square',
                authority: [accessWayCollection.super, accessWayCollection.planSale.addBasicInfo],
                component: './PlanSale/Add',
              },
              {
                path: '/marketing/planSale/list/:pageKey',
                hideInMenu: true,
                component: './PlanSale/List',
              },
              { path: '/marketing/planSale/list/', redirect: '/marketing/planSale/list/no' },
              {
                path: '/marketing/planSale/list/no',
                name: 'list',
                icon: 'bars',
                authority: [accessWayCollection.super, accessWayCollection.planSale.list],
              },
            ],
          },
        ],
      ...
      },
      {
        ...
        authority: [
          accessWayCollection.super,
          accessWayCollection.advertisement.add,
          accessWayCollection.advertisement.list,
          accessWayCollection.qRCode.add,
          accessWayCollection.qRCode.list,
          accessWayCollection.callCenter.add,
          accessWayCollection.callCenter.list,
        ],
        routes: [
          {
            path: '/assistTools',
            redirect: '/assistTools/advertisement',
          },
          {
            name: 'advertisement',
            icon: 'picture',
            path: '/assistTools/advertisement',
            authority: [accessWayCollection.super, accessWayCollection.advertisement.list],
            routes: [
              {
                path: '/assistTools/advertisement/add',
                name: 'add',
                icon: 'plus-square',
                hideInMenu: true,
                authority: [
                  accessWayCollection.super,
                  accessWayCollection.advertisement.addBasicInfo,
                ],
                component: './Advertisement/Add',
              },
              {
                path: '/assistTools/advertisement/list/:pageKey',
                hideInMenu: true,
                component: './Advertisement/List',
              },
              {
                path: '/assistTools/advertisement/list/no',
                name: 'list',
                icon: 'bars',
                authority: [accessWayCollection.super, accessWayCollection.advertisement.list],
              },
              {
                path: '/assistTools/advertisement/edit/:op/:id/:pageKey',
                name: 'edit',
                hideInMenu: true,
                component: './Advertisement/Edit',
                routes: [
                  {
                    path: '/assistTools/advertisement/edit/:op/:id/:pageKey/basicInfo',
                    name: 'basicInfo',
          ...
          },
          {
            ...
            routes: [
              ...
              {
                path: '/assistTools/qRCode/list/:pageKey',
                hideInMenu: true,
                component: './QRCode/List',
              },
              {
                path: '/assistTools/qRCode/list/no',
                name: 'list',
                icon: 'bars',
                authority: [accessWayCollection.super, accessWayCollection.qRCode.list],
              },
          ...
          },
          {
            ...
            routes: [
              ...
              {
                path: '/assistTools/callCenter/list/:pageKey',
                hideInMenu: true,
                component: './CallCenter/List',
              },
              {
                path: '/assistTools/callCenter/list/no',
                name: 'list',
                icon: 'bars',
                authority: [accessWayCollection.super, accessWayCollection.callCenter.list],
              },
